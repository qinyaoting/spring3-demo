...
function ajaxTestException()
{
	$.ajax( {
		type : 'GET',
		url : '${basePath}/exc/josonException.action',   
...
{
	 window.location.href=" <c:url value="/exc/SystemException.action"/>";
}
function BusinessException()
{
	 window.location.href=" <c:url value="/exc/BusinessException.action"/>";
}
</script>
</head>
<body>
