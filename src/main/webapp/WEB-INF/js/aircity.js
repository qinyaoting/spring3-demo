...
//common//citys[0]=new Array('SZX','深圳','SHENZHEN','SZ');

//common//citys[1]=new Array('PEK','北京','BEIJING','BJ');

//common//citys[2]=new Array('SHA','上海','SHANGHAI','SH');

//common//citys[3]=new Array('CAN','广州','GUANGZHOU','GZ');

//common//citys[4]=new Array('CTU','成都','CHENGDU','CD');

//common//citys[5]=new Array('HGH','杭州','HANGZHOU','HZ');

//common//citys[6]=new Array('CSX','长沙','CHANGSHA','CS');

//common//citys[7]=new Array('CKG','重庆','CHONGQING','CQ');

//common//citys[8]=new Array('KMG','昆明','KUNMING','KM');

//common//citys[9]=new Array('XIY','西安','XIAN','XA');

//common//citys[10]=new Array('WUH','武汉','WUHAN','WH');

//common//citys[11]=new Array('NKG','南京','NANJING','NJ');

//common//citys[12]=new Array('TAO','青岛','QINGDAO','QD');

//common//citys[13]=new Array('SYX','三亚','SANYA','SY');

//common//citys[14]=new Array('XMN','厦门','XIAMEN','XM');
